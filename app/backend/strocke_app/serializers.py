...
from .models import Patients, ClinicalData, CtImages, Predictions, Prescription
...
class PrescriptionSerializer(serializers.ModelSerializer):
    patient_name = serializers.CharField(source='patient.full_name', read_only=True)
    doctor_name  = serializers.CharField(source='doc.username', read_only=True)

    class Meta:
        model  = Prescription
        fields = ['id', 'patient', 'patient_name', 'doc', 'doctor_name',
                  'prescription', 'created_at']
        read_only_fields = ['id', 'doc', 'created_at']
